...
- **Lean Core Desktop:** Zero bloat. Installs only `mangowc`, `noctalia`, `kitty`, and essential Wayland portals/utilities. No NVIDIA proprietary builds, no OBS, and no heavy unnecessary apps.
